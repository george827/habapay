    ...
    return (
        ...
        <div className="manage2">
            ...
            <div className="detail-section">
                ...
                <div className="edit">
                    <Link to="/edit" className="link-style"> <img src={EditPersonIcon} className="edit-icons" alt="BsPersonFillX" /> <p>Edit Profile</p> </Link>
                    <Link to="/suspend" className="link-style"><BsPersonFillX className="edit-icons"/>  <p>Suspend</p></Link>
                    <Link to="/delete" className="link-style"><BsFillTrash3Fill className="edit-icons" />  <p>Delete</p></Link>
                </div>
            </div>
        </div>
        <br/>
